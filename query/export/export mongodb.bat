...
mongoexport -d HotelBookingReservationsSystem -c my-hotel-reservation-history -o D:\thesis-in-process\my-hotel\query\json\my-hotel-reservation-history.json
