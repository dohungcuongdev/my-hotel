...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading" style="font-weight: bold; color:red">Sửa lịch đặt phòng</header>
            <div class="panel-body">
                <form:form method="post" commandName="reservation" action="" id="reservationform">
                    ...
                    <div class="form-group">
                        <form:select class="form-control m-b-10" path="status" id="status">
                            <form:option value="Khách đang ở">Khách đang ở</form:option>
                            <form:option value="Chưa Thanh Toán">Qua đêm</form:option>
                            <form:option value="Đã Thanh Toán">Qua đêm</form:option>
                        </form:select>
                    </div>
