...
<div class="row">
    <div class="col-xs-12">
        <div class="panel">
            <header class="panel-heading">Lịch sử đặt phòng</header>
				 ...
				 <table id="table-rooms"  class="table-responsive" border="1">
				     ...
				     <c:forEach var="reservation" items="${reservations}" varStatus="loop">
				         <tr>
				             ...
				             <td><button onclick="location.href = '${pageContext.request.contextPath}/sua-lich-dat-phong/${reservation.id}.html'" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></button></td>
				             <td><button onclick="location.href = '${pageContext.request.contextPath}/tra-phong/${reservation.id}.html'" class="btn btn-default btn-xs"><i class="fa fa-check"></i></button></td>
